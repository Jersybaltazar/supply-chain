...
export const DistributorMenu = async ({ distributor }: DistributorQuery) => {
  ...
  return (
    <div className="flex flex-col w-full max-w-xs gap-2">
      ...
      <div className="flex flex-col gap-2">
        <Link href="/distributor">{t('panel')}</Link>
        <Link href="/distributor/warehouses">{tm('manageWarehouses')}</Link>
