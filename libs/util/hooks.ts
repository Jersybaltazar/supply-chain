...
export const useSearchLocation = () => {
  ...
  useEffect(() => {
    ...
    setLoading(true)
    fetch(
      `https://api.mapbox.com/geocoding/v5/mapbox.places/${debouncedSearchText}.json?fuzzyMatch=true&country=pe&language=es&access_token=${process.env.NEXT_PUBLIC_MAPBOX_TOKEN}`,
    )
